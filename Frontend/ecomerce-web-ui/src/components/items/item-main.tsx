...
const products = [
    { id: 1, name: 'Product 1', price: 10.99, brand: 'Brand A', description: 'Description of Product 1', itemImage: 'https://img.lazcdn.com/g/p/f01c91f5036e2419cfaf626ba752c836.jpg_400x400q80.jpg_.avif' },
